...
@.str = private unnamed_addr constant [15 x i8] c"\D0\9C\D0\BE\D0\B4\D1\83\D0\BB\D1\8C: \00", align 1
...
define i32 @main() #4 {
  ...
  call void @_ZNSt7complexIdEC2Edd(%"struct.std::complex"* %2, double 3.000000e+00, double 4.000000e+00)
  %3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0))
  %4 = call double @_ZSt3absIdET_RKSt7complexIS0_E(%"struct.std::complex"* dereferenceable(16) %2)
  %5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %3, double %4)
...
define linkonce_odr double @_ZSt3absIdET_RKSt7complexIS0_E(%"struct.std::complex"* dereferenceable(16)) #6 comdat {
  %2 = alloca %"struct.std::complex"*, align 8
